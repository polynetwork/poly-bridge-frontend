  ...
  <Page class="transactions">
    ...
    <div class="airdrop-container">
      <div class="info">
        ...
        <p v-if="airdropStatus === 0 && !addressFlag">
          <span>{{ $t('airdrop.desc1') }}</span>
        </p>
        <p v-if="airdropStatus === 0 && userData[currentId].Rank === 0">
          <span>{{ $t('airdrop.desc2') }}</span>
        </p>
        <p v-if="airdropStatus === 0 && userData[currentId].Rank > 1000">
          <span>{{ $t('airdrop.desc3') }}</span>
        </p>
        <p
          v-if="
            airdropStatus === 0 && userData[currentId].Rank <= 1000 && userData[currentId].Rank > 0
          "
        >
      ...
      <div class="data">
        ...
        <div v-if="addressFlag" class="content">
          <div class="item">
            <div class="no">
              <div class="rank">
                {{ userData[currentId].Rank === 0 ? 'NaN' : userData[currentId].Rank }}
              </div>
              <div class="small"></div>
              <div class="big"></div>
            </div>
...
export default {
  ...
  computed: {
    airdropStatus() {
      ...
      let res = 0;
      if (timestamp < 1659942000000) {
        res = 0;
      }
      if (timestamp >= 1659942000000 && timestamp < 1662620400000) {
        res = 1;
      }
      if (timestamp >= 1662620400000) {
        res = 2;
      }
      console.log(res);
      return res;
